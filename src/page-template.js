function generateHTML(teamArray) {
    ...
    if (role === "Manager") {
      cardSection += `<div class="col-9-sm col-6-md col-lg-3 card shadow p-0 mb-5 bg-light rounded mx-4">
                              <div class="card-body px-0 py-0">
                                  <div class="card-header header px-3">
                                      ...
                                      <h6 class="card-subtitle font-weight-bold"><span class = "icon mr-1"><i class="fa-regular fa-handshake"></i></span>Manager</h6>
                                  </div>
      ...
      cardSection += `  <div class="col-9-sm col-6-md col-lg-3 card shadow p-0 mb-5 bg-light rounded mx-4">
            <div class="card-body px-0 py-0">
                <div class="card-header header px-3">
                    <h5 class="card-title font-weight-bold">${employee.name}</h5>
                    <h6 class="card-subtitle font-weight-bold"><span class = "icon mr-1"><i class="fa-solid fa-file-pen"></i></span>Intern</h6>
                </div>
                <ul class="card-text list-group mt-2 px-3 py-3 list">
                    <li id="ID list-group-item">ID: ${employee.id}</li>
                    <li id="email list-group-item">Email: <a href="mailto:${employee.email}">${employee.email}</a></li>
  ...
  let pageHTML = `<!DOCTYPE html>
    ...
    <header>
        <h1 class="title text-left ml-5 py-2 font-weight-bolder"> <span class="icon" id="header-icon"><i class="fa-regular fa-address-card"></i></span> My Team</h1>
    </header>
